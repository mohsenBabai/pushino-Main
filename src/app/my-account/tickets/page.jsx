...
export default function page() {
  return (
    <div className="flex flex-col lg:flex-row gap-x-8 mt-10 px-4 xl:px-10  font-Dana ">
      ...
      {/* main */}
      <div className="w-full flex flex-col shadow rounded-lg p-4 dark:bg-gray-800 bg-white lg:w-3/4 mt-5 lg:mt-0">
        {/* header */}
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-x-2">
            ...
            <h2 className="font-Dana-Medium text-lg">پیام های من :</h2>
          </span>
        </div>
        <ul className="mt-5 space-y-5">
          <li className="w-full border border-blue-300 dark:border-blue-400 p-4 rounded-lg relative">
            <div className="flex flex-col">
              <div className="flex justify-start text-sm sm:text-base md:text-lg text-green-400 mb-2 sm:mb-3">
                محسن بابایی عزیز سفارش شما با کد رهگیری 5412zas ارسال شد
              </div>
              <div className="flex items-center justify-between">
                <div className="text-sm flex items-center justify-center gap-2.5  text-black/50 dark:text-white transition-all">
                  <span className="flex items-center justify-center pt-1.5 ">
                    <p>1404/01/23</p>
                    <span className="flex w-[10px] h-[1px] bg-white mx-2"></span>
                    <p>14:19</p>
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  className="flex items-center justify-center group gap-x-1.5 text-blue-400 dark:text-blue-500 bg-blue-100/60 dark:bg-blue-500/10 rounded-xl py-2 px-2.5"
                  href={"/"}
                >
                  <p className=" hidden xs:flex text-xs  md:text-sm">
                    رهگیری سفارش
                  </p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="size-4 sm:size-5 group-hover:-translate-x-1  transition-transform ease-in-out duration-300"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
          ...
          <li className="w-full border border-blue-300 dark:border-blue-400 p-4 rounded-lg relative">
            <div className="flex flex-col">
              <div className="flex justify-start text-sm sm:text-base md:text-lg text-yellow-400 mb-2 sm:mb-3">
                محسن بابایی عزیز سفارش شما در حال رهگیری میباشد
              </div>
              <div className="flex items-center justify-between">
                <div className="text-sm flex items-center justify-center gap-2.5  text-black/50 dark:text-white transition-all">
                  <span className="flex items-center justify-center pt-1.5 ">
          ...
          <li className="w-full border border-blue-300 dark:border-blue-400 p-4 rounded-lg relative">
            <div className="flex flex-col">
              <div className="flex justify-start text-sm sm:text-base md:text-lg text-red-400 mb-2 sm:mb-3">
                محسن بابایی عزیز سفارش شما با خطا مواجه شده است
              </div>
              <div className="flex items-center justify-between">
                <div className="text-sm flex items-center justify-center gap-2.5  text-black/50 dark:text-white transition-all">
                  <span className="flex items-center justify-center pt-1.5 ">
