...
export default function page() {
  return (
    <div className="flex flex-col lg:flex-row gap-x-8 mt-10 px-4 xl:px-10  font-Dana ">
      ...
      {/* main */}
      <div className="flex flex-col shadow rounded-lg p-4 dark:bg-gray-800 bg-white lg:w-3/4 mt-5 lg:mt-0">
        {/* header */}
        <div className="flex items-center justify-between">
          ...
          <span className="flex items-center gap-x-2 text-blue-500 dark:text-white cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <p className="font-Dana-Medium text-base pt-1 hidden sm:flex">
              مشاهده فاکتور
            </p>
          </span>
        </div>
