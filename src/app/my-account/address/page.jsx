...
export default function page() {
  return (
    <div className="flex flex-col lg:flex-row gap-x-8 mt-10 px-4 xl:px-10  font-Dana ">
      ...
      <div className="w-full flex flex-col shadow rounded-lg p-4 dark:bg-gray-800 bg-white mt-5 lg:mt-0">
        <div className="flex items-center justify-between">
          ...
          <button className="flex items-center gap-x-1 text-blue-500 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <ul className="mt-5 space-y-5">
          <li className="w-full border border-blue-300 dark:border-blue-400 p-4 rounded-lg relative">
            ...
            <div className=" absolute bottom-3 left-3 flex items-center justify-center gap-3">
              <span className="">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <span className="">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="size-5.5 cursor-pointer text-red-500"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
