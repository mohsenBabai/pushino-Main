...
export default function page() {
  return (
    <div className="flex flex-col lg:flex-row gap-x-8 mt-10 px-4 xl:px-10  font-Dana ">
      ...
      <div className="lg:w-3/4 flex flex-col shadow rounded-lg p-4 dark:bg-gray-800 bg-white mt-5 lg:mt-0">
        {/* header */}
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-x-2">
            ...
            <h2 className="font-Dana-Medium text-lg pt-1.5">
              اطلاعات حساب کاربری :
            </h2>
          </span>
        </div>
        <div className="flex flex-col sm:flex-row gap-x-5 xs:gap-x-8 lg:gap-x-16 items-start mt-4 gap-y-7">
          <div className=" flex flex-col w-full sm:w-auto  sm:flex-1/2 space-y-7">
            <div className=" flex flex-col  gap-2">
              <p className="text-gray-500 text-base dark:text-gray-300">
                {" "}
                نام و نام خانوادگی :
              </p>
              <span className=" flex items-center justify-between w-full  bg-gray-200/70 dark:bg-gray-700  p-2 rounded-xl cursor-pointer ring-blue-400  transition-all z-40">
                <input
                  type="text"
                  placeholder="محسن بابایی"
                  className=" outline-none placeholder:text-gray-400 placeholder:text-sm"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="size-5.5 text-gray-400"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
